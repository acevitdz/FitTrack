enum ExerciseExecutionMode { repetition, timer }

enum ExerciseCueMode { voice, countdown }
...
class Exercise {
  ...
  Exercise copyWith({
    ...
    tempoUp: tempoUp ?? this.tempoUp,
    tempoHold: tempoHold ?? this.tempoHold,
    tempoDown: tempoDown ?? this.tempoDown,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (cueMode != null) 'cueMode': cueMode!.name,
    if (tempoUp != null) 'tempoUp': tempoUp,
    if (tempoHold != null) 'tempoHold': tempoHold,
    if (tempoDown != null) 'tempoDown': tempoDown,
  };
  ...
  factory Exercise.fromJson(Map<String, dynamic> json) => Exercise(
    ...
    executionMode: json['executionMode'] != null
        ? ExerciseExecutionMode.values.asNameMap()[json['executionMode']]
        : null,
    cueMode: json['cueMode'] != null
        ? ExerciseCueMode.values.asNameMap()[json['cueMode']]
        : null,
    tempoUp: json['tempoUp'] as int?,
    tempoHold: json['tempoHold'] as int?,
    tempoDown: json['tempoDown'] as int?,
  );
}
