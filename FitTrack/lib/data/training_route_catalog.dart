...
/// `docs/32_lo_trinh_tap_luyen_firebase.md`. This builder expands each stable
...
abstract final class TrainingRouteCatalog {
  ...
  static const _exerciseCatalogSource = SourceReference(
    ...
    title: 'FitTrack Firebase reviewed exercise catalog',
    publisher: 'FitTrack',
    url: 'https://fittrack-cse441-6c062.firebaseapp.com/',
    publicationYear: 2026,
    notes:
        'Exercise IDs đã được đối chiếu với 163 bài published, active và visible ngày 31/07/2026.',
  );
  ...
  static final List<Program> programs = List.unmodifiable([
    for (final route in _routes)
      Program(
        id: route.code,
        title: '${route.code} — ${route.profileLabel}',
        description:
  ...
  static ProgramVersion _buildVersion(_RouteSpec route, int frequency) {
    ...
    return ProgramVersion(
      ...
      accessibilityLabel:
          '${route.profileLabel}; $frequency buổi mỗi tuần; cue chữ và '
          'Guided Confirmation có sẵn cho mọi bài.',
  ...
  static ProgramSession _buildSession({
    ...
    return ProgramSession(
      id: sessionId,
      weekId: weekId,
      title: '${template.label} · ${template.focus}',
      order: order,
  ...
  static ExercisePrescription _materializePrescription({
    ...
    return ExercisePrescription(
      ...
      prescriptionVersion: '32-routes-v1',
  ...
  static _SessionTemplate _lightSession(_RouteSpec route) {
    ...
    return _SessionTemplate(
      label: 'D-${route.code.substring(0, 2)}',
      focus: 'Buổi D nhẹ',
      isLight: true,
      prescriptions: [
  ...
  static _PrescriptionSpec _progressPrescription(
    ...
    if (weekNumber == 4 || weekNumber == 8) {
      return source.copyWith(sets: math.max(1, (source.sets * .7).round()));
    }
  ...
  static String _weekTitle(_RouteSpec route, int weekNumber) {
    ...
    if (weekNumber == 4) return 'Tuần 4 · Deload 30% số hiệp';
