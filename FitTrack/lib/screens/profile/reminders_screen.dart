    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Thông báo có thể đến trễ do chế độ tiết kiệm pin của Android. Buổi tập đang diễn ra vẫn hoạt động khi bạn không cấp quyền thông báo.',
