  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            AppState.displaySessionTitle(snapshot.title),
            style: Theme.of(context).textTheme.headlineSmall,
          ),
          const SizedBox(height: 4),
          Text(
            '${AppState.displayStoredProgramTitle(snapshot.programTitle)}'
          ...
          _SectionCard(
            ...
            children: [
              ...
              _DetailRow(
                ...
                value: snapshot.contentVersion.isEmpty
                    ? 'Phiên bản đã lưu cùng buổi tập'
                    : 'Phiên bản ${snapshot.contentVersion}',
              ),
            ],
          ),
          ...
          if (cameraEvents.isNotEmpty) ...[
            ...
            _SectionCard(
              title: 'Số liệu nhận diện từ camera',
              children: [
                Text(
          ...
          _SectionCard(
            ...
            children: [
              if (snapshot.sourceRefs.isEmpty)
                const Text(
                  'Không có nguồn được ghi trong dữ liệu buổi tập đã lưu.',
      ...
      children: [
        if (exercise.isAlternative)
          ListTile(
            ...
            subtitle: Text('Bài gốc: ${_exerciseNameFor(exercise.prescribedExerciseId)}'),
          ),
        if (events.isEmpty)
          const Padding(
